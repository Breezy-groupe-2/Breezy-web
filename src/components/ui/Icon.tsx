...
function getPath(name: IconName, color: string): React.ReactNode {
  switch (name) {
    ...
    case "heart":     return <path d="M12 20.7l-1.32-1.2C6 15.36 3 12.64 3 9.3 3 6.6 5.1 4.5 7.8 4.5c1.5 0 3 .7 4.2 2 1.2-1.3 2.7-2 4.2-2 2.7 0 4.8 2.1 4.8 4.8 0 3.34-3 6.06-7.68 10.2L12 20.7z" />;
    case "heartFill": return <path d="M12 20.7l-1.32-1.2C6 15.36 3 12.64 3 9.3 3 6.6 5.1 4.5 7.8 4.5c1.5 0 3 .7 4.2 2 1.2-1.3 2.7-2 4.2-2 2.7 0 4.8 2.1 4.8 4.8 0 3.34-3 6.06-7.68 10.2L12 20.7z" fill={color} stroke={color} />;
