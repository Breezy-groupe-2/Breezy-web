        ...
        {step === 0 && (
          <div className="w-full max-w-[360px] mt-5">
            ...
            <button
              ...
              className="w-full h-[52px] flex items-center justify-center gap-3 rounded-[16px] transition-opacity disabled:opacity-60"
              style={{
                background: "var(--surface)",
                boxShadow: "inset 0 0 0 1.5px var(--border), var(--card-shadow)",
              }}
            >
              {googleLoading ? (
                <span className="w-4 h-4 rounded-full border-2 border-current border-t-transparent animate-spin" style={{ color: "var(--text-faint)" }} />
              ) : (
