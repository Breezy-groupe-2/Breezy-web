...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    Promise.all([getProfile(resolvedUsername), getUserPosts(resolvedUsername)])
      .then(([prof, userPosts]) => {
        setProfile(prof);
        setPosts(userPosts);
  ...
  function handleFollow() {
    ...
    setProfile((p) => (p ? { ...p, followersCount: p.followersCount + (willFollow ? 1 : -1) } : p));
    ...
    <div className="flex flex-col scrollbar-hide overflow-y-auto min-h-svh">
      ...
      <div className="px-5">
        <div className="flex justify-between items-end -mt-9">
          <div style={{ boxShadow: '0 0 0 4px var(--bg)', borderRadius: 'var(--r-avatar)' }}>
      ...
      {userListMode && (
        <div className="fixed inset-0 z-[60] flex flex-col justify-end">
          ...
          >
            <div
              className="w-10 h-1.5 rounded-full mx-auto mt-2.5 shrink-0"
              ...
              {userListLoading ? (
                ...
                (() => {
                  ...
                  return filtered.length === 0 ? (
                    <p
                      className="text-center text-[14px] py-10"
      ...
      {editOpen && (
        <div className="fixed inset-0 z-[60] flex flex-col justify-end">
          ...
          >
            <div
              className="w-10 h-1.5 rounded-full mx-auto mt-2.5"
              style={{ background: 'var(--border)' }}
            />
            ...
            <div className="flex flex-col gap-4 px-5 pb-10">
              <div>
                <label
                  className="block text-[13.5px] font-bold mb-1.5 ml-1"
                  style={{ color: 'var(--text-muted)' }}
                >
                  Nom
                </label>
